...
class numeroALetraConvertidor{
    ...
    public function aLetras($number, $miMoneda = null){
        ...
        if (intval($millones) > 0) {
            if ($millones == '001') {
                ...
                $converted .= sprintf('%sMILLONES ', $this->convertGroup1($millones));
            }
        }
        ...
        if (intval($miles) > 0) {
            if ($miles == '001') {
                ...
                $converted .= sprintf('%sMIL ', $this->convertGroup1($miles));
            }
        }
   ...
   private function convertGroup1($n){
        $output = '';
        ...
        if ($k <= 20) {
            ...
            if(($k > 30) && ($n[2] !== '0')) {
                $output .= sprintf('%sY %s', $this->DECENAS[intval($n[1]) - 2], $this->UNIDADES1[intval($n[2])]);
            } else {
                $output .= sprintf('%s%s', $this->DECENAS[intval($n[1]) - 2], $this->UNIDADES1[intval($n[2])]);
            }
        }
